...
class ApplicationWindow(QWidget):
    def __init__(self):
        ...
        self.Astar_h1 = Astar9.Astar(self.initList, self.goal, 1)    # 生成h1的Astart类
        self.Astar_h2 = Astar9.Astar(self.initList, self.goal, 2)    # 生成h2的Astart类
    ...
    def randomGenerate(self):
        ...
        for n in range(int(self.randomText.text())):
            ...
            go = [1,-1,2,-2]
            # 随机置换一个数
            indexi = random.randint(0,2)
            indexj = random.randint(0,2)
            # 根据位置去除可以行走的方向
            if indexi == 0:
                go.remove(1)
            if indexi == 2:
        ...
        self.Astar_h1 = Astar9.Astar(self.initList, self.goal, 1)
        self.Astar_h2 = Astar9.Astar(self.initList, self.goal, 2)
        self.G1 = nx.Graph()
        self.G2 = nx.Graph()
